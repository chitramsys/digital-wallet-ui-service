     ...
     <div className={sideBarCollapsed ? "col-auto col-md-1 col-xl-1 px-sm-1 px-0 bg-dark":"col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark"} >
            <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    <li className="nav-item" style={{paddingBottom:'15px'}} onClick={()=>sideBarCollapse()}>
                    ...
                    <li className="nav-item" style={{paddingBottom:'15px'}} onClick={()=>navigateTo('wallet')}>
                        <a href="#" className="nav-link align-middle px-0">
                       <RiCurrencyFill style={{width:'2rem',height:'2rem', textAlign:'center'}} /> <span  className={sideBarCollapsed ? "ms-1 isSideBarCollapsed":"ms-1 isSideBarNotCollapsed"}>Transaction</span>
                        </a>
                    </li>

                    <li className="nav-item" style={{paddingBottom:'15px'}} onClick={()=>navigateTo('transaction')}>
                        <a href="#" className="nav-link align-middle px-0">
                       <RiCurrencyFill style={{width:'2rem',height:'2rem'}} /> <span  className={sideBarCollapsed ? "ms-1 isSideBarCollapsed":"ms-1 isSideBarNotCollapsed"}> History</span>
                        </a>
                    </li>
